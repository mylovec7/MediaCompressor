# MediaCompressor — Sovereign Obsidian Rose Edition

Offline Android media workstation by **Vr3tH🇵🇸**.

## Design direction
- Sovereign Obsidian Rose: deepest-void obsidian base, frosted specular glass cards, luminous rose accents.
...
- Active processing/status accents use electric rose; success/error states remain distinct.
