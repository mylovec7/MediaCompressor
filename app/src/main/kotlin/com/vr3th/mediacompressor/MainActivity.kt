...
class MainActivity : Activity() {
    ...
    private val pinkSoft = Color.parseColor("#35E58C")    // Electric Mint — secondary green (labels/subtitles)
    private val pinkElectric = Color.parseColor("#FF2B8D") // Cyber Rose — SOLE surviving accent: laser border / select highlight only
    ...
    private val gray = Color.parseColor("#FCE4EC")        // Champagne Rose (secondary telemetry text)
    ...
    private val batchableOps = setOf(
        ...
        "Audio Trim & Reverse", "Audio Volume Booster", "Audio Silence Trimmer",
    ...
    private fun rangeUI(r: LinearLayout, title: String, start: String, end: String, unit: String, tooltip: String? = null, onValid: (Double, Double) -> Unit) {
    ...
    private fun fpsUI(r: LinearLayout, tooltip: String? = null) {
    ...
    private fun delayUI(r: LinearLayout, tooltip: String? = null) {
            ...
            outcomes.forEach { outcome ->
                when (outcome) {
                    is EngineResult.Success -> {
                        ...
                        val statusLine = if (publishedUri != null) bi("✓ Tersimpan di Galeri", "✓ Saved to Gallery") else bi("Output lokal", "LOCAL OUTPUT")
