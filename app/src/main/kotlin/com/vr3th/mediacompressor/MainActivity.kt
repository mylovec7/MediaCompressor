...
class MainActivity : Activity() {
    ...
    private val bg = Color.parseColor("#07060B")          // Deepest Void Obsidian
    private val panel = Color.parseColor("#12101E")       // Dark Obsidian Glass
    private val panelStroke = Color.parseColor("#3D3055") // top-lit specular stroke
    private val activeCardBg = Color.parseColor("#1E122C") // Tinted Rose Chamber (active card fill)
    private val pinkSoft = Color.parseColor("#FF59A2")    // Holographic Blossom
    private val pinkElectric = Color.parseColor("#FF1177") // Quantum Electric Rose
