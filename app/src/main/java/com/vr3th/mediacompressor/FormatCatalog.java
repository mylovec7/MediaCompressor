...
final class FormatCatalog {
    ...
    static String report() {
        ...
        s.append("VIDEO INPUT // CONTAINER HINTS (DECODER DEPENDENT)\n");
        ...
        s.append("Input support is determined by the actual decoder exposed by the device; the list is not a guarantee for every codec inside a container.\n");
        return s.toString();
    }
}
