...
public class MainActivity extends Activity{
    ...
    Uri publishImage(File f,boolean webp)throws IOException{
        ...
        return publishGeneric(f,webp?"image/webp":"image/jpeg","Download/MediaCompressor/Images",n);
    }
    ...
    Uri publishAudio(File f)throws IOException{
        return publishGeneric(f,"audio/mp4","Download/MediaCompressor/Audio","AUD_"+System.currentTimeMillis()+".m4a");
    }
    ...
    void publishDirectory(File d)throws IOException{
        ...
        // Extracted ZIPs are copied into the public Download/MediaCompressor/Extract tree.
        ...
        for(File f:files){
            ...
            if(Build.VERSION.SDK_INT>=29)v.put(MediaStore.MediaColumns.RELATIVE_PATH,"Download/MediaCompressor/Extract/"+(dir.isEmpty()?"":dir+"/"));
