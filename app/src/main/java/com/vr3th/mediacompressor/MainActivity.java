...
public class MainActivity extends Activity{
    ...
    void compressPhoto(Uri u){new Thread(()->{File f=null;Bitmap b=null;try{
        ...
        publishImage(f,false); safe(f); showStatus("> COMPRESSION COMPLETE\n"+fmtSize(s)+" → "+fmtSize(best)+"\nQUALITY "+used+"\n✓ OUTPUT VERIFIED\n✓ ORIGINAL PRESERVED\n✓ SAVED TO GALLERY");
    ...
    void publishDirectory(File d,String rootName)throws IOException{
        ...
        for(File f:files){
            ...
            if(Build.VERSION.SDK_INT>=29)v.put(MediaStore.MediaColumns.RELATIVE_PATH,"Download/MediaCompressor/Extract/"+rootName+"/"+(dir.isEmpty()?"":dir+"/"));
