...
public class MainActivity extends Activity{
    ...
    String fmtDuration(long us){ if(us<0)return "INVALID"; long ms=Math.max(0,us/1000); long h=ms/3600000; ms%=3600000; long m=ms/60000; ms%=60000; long sec=ms/1000; long rem=ms%1000; return h>0?String.format(Locale.US,"%02d:%02d:%02d.%03d",h,m,sec,rem):String.format(Locale.US,"%02d:%02d.%03d",m,sec,rem);}
