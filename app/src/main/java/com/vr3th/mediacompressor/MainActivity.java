...
public class MainActivity extends Activity{
    ...
    Uri publishGeneric(File f,String mime,String rel,String name)throws IOException{
        ...
        if(Build.VERSION.SDK_INT>=29)v.put(MediaStore.MediaColumns.RELATIVE_PATH,Environment.DIRECTORY_DOWNLOADS+"/"+rel);
    ...
    void publishDirectory(File d){/* kept private to app storage; no unsafe broad storage permission */}
