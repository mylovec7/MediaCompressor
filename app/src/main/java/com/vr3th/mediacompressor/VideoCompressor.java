...
public final class VideoCompressor {
    ...
    void run(Uri src, AtomicBoolean cancel){
        ...
        try{
            ...
            // Adaptive VBR target: lower than the previous 0.08 bppf, with sane floors/caps. Quality guard rejects bad/large results.
            long bitrate=(long)width*height*fps*4/100;
            bitrate=Math.max(900_000L,Math.min(4_500_000L,bitrate));
